...
urlpatterns = [
    ...
    path('produto/adicionar_carrinho/<int:produto_id>/<int:produto_desconto>/<str:produto_nome>/<str:produto_preco_com_desconto>/<path:produto_imagem>', views.adicionar_carrinho, name='adicionar_carrinho'),
